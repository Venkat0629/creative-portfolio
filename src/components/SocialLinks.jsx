...
const SocialLinks = ({ email, github, linkedin }) => {
  return (
    <div className="socials" aria-label="Social links" role="navigation">
      <h2 className="visually-hidden">Social Links</h2>
      <a className="icon-btn" href={`mailto:${email || 'someone@example.com'}`} aria-label="Email" tabIndex={0} role="link">
      ...
      <a className="icon-btn" href={github || 'https://github.com/'} target="_blank" rel="noopener" aria-label="GitHub" tabIndex={0} role="link">
      ...
      <a className="icon-btn" href={linkedin || 'https://www.linkedin.com/'} target="_blank" rel="noopener" aria-label="LinkedIn" tabIndex={0} role="link">
